...
class VoltDetector:
    ...
    def __init__(self, model_dir: str, tol = 0.9, proc_core: int = _DEALER_CORE, reader_core: int = _READER_CORE):
...
def parse_args():
    ...
    parser.add_argument("-t", "--tol", type=float, default=0.7)
    return parser.parse_args()

def main():
    args = parse_args()
    detector = VoltDetector(args.model, args.tol)
    detector.start()
